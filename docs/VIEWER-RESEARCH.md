...
**Status (2026-08-21, AMENDMENT 87):** the essential fixes are implemented —
...
Status: ✅ done in AMENDMENT 87 · ⏸ deferred by decision (2026-08-21 — keep
...
4. ✅ Reset/re-frame: F key + fit button, works for camera-less models and
   ...
   re-framed pose off — see AMENDMENT 87).
