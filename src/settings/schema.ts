...
export const SETTINGS: SettingDef[] = [
  ...
  {
    id: 'previewQuality', label: 'Card / preview resolution', group: 'textures', kind: 'select', default: '448',
    options: [
      { value: '224', label: '224×140 (fastest)' }, { value: '320', label: '320×200' },
      { value: '448', label: '448×280' }, { value: '640', label: '640×400 (sharpest)' },
    ],
    deferred: true,
  },
...
export const PRESETS: Record<string, SettingsValues> = {
  low: {
    ...
    previewQuality: '224', shadows: 'off', ao: 'off', ssr: false,
  ...
  medium: {
    ...
    previewQuality: '320', shadows: 'contact', contactShadowStrength: 45, ao: 'off', ssr: false,
    bloom: false, vignette: false, grain: false,
  ...
  high: {
    ...
    previewQuality: '448', shadows: 'contact', contactShadowStrength: 55, ao: 'ssao2', aoStrength: 90, aoSamples: 8, ssr: false,
  ...
  ultra: {
    ...
    previewQuality: '640', shadows: 'dynamic', shadowQuality: '2048', shadowSoftness: 45,
